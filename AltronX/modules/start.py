...
PythonButton = [
        ...
        [
        Button.url("⚡️𝗖𝗛𝗔𝗡𝗡𝗘𝗟⚡️", "https://t.me/botxhubop"),
        Button.url("⚡️𝗦𝗨𝗣𝗣𝗢𝗥𝗧⚡️", "https://t.me/botxhubchat")
        ],
        [
        Button.url("⚡️𝗥𝗘𝗣𝗢⚡️", "https://github.com/GENZ-ARSH/ARSH-SPAM-X.git")
        ]
        ]
...
async def start(event):              
    if event.is_private:
        ...
        TEXT += f"» **✦ 𝗗𝗘𝗩𝗘𝗟𝗢𝗣𝗘𝗗 𝗕𝗬 :~ [𝐀𝐑𝐒𝐇](https://t.me/arsh_always)**\n\n"
